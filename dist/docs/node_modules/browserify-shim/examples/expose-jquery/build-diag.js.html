...
<html>
<head>
  <title>build-diag.js</title>
  <meta http-equiv="content-type" content="text/html; charset=UTF-8">
  <link rel="stylesheet" media="all" href="../../../../doc-style.css" />
  <script src="../../../../doc-filelist.js"></script>
  <script>
    var relativeDir = "../../../../", thisFile = "home/danny/youlooknice/node_modules/browserify-shim/examples/expose-jquery/build-diagjs", defaultSidebar = true;
  </script>
...
<span class="nx">process</span><span class="p">.</span><span class="nx">env</span><span class="p">.</span><span class="nx">BROWSERIFYSHIM_DIAGNOSTICS</span> <span class="o">=</span> <span class="mi">1</span><span class="p">;</span>
...
<span class="p">(</span><span class="kd">function</span> <span class="nx">bundle</span><span class="p">()</span> <span class="p">{</span>
...
<p>This is function is the important part and should be similar to what you would use for your project</p>
        </td>
        <td class="code highlight"><div class="highlight"><pre>
  <span class="kd">var</span> <span class="nx">builtFile</span> <span class="o">=</span> <span class="nx">path</span><span class="p">.</span><span class="nx">join</span><span class="p">(</span><span class="nx">__dirname</span><span class="p">,</span> <span class="s1">&#39;js&#39;</span><span class="p">,</span> <span class="s1">&#39;bundle.js&#39;</span><span class="p">);</span>
...
<p>this resolves main file of our package</p>
        </td>
        <td class="code highlight"><div class="highlight"><pre>
    ...
    <span class="p">.</span><span class="nx">on</span><span class="p">(</span><span class="s1">&#39;end&#39;</span><span class="p">,</span> <span class="kd">function</span> <span class="p">()</span> <span class="p">{</span>
      <span class="nx">console</span><span class="p">.</span><span class="nx">log</span><span class="p">(</span><span class="s1">&#39;Build succeeded, open index.html to see the result.&#39;</span><span class="p">);</span>
    <span class="p">})</span>
    ...
    <span class="p">.</span><span class="nx">pipe</span><span class="p">(</span><span class="nx">fs</span><span class="p">.</span><span class="nx">createWriteStream</span><span class="p">(</span><span class="nx">builtFile</span><span class="p">,</span> <span class="s1">&#39;utf8&#39;</span><span class="p">))</span>
<span class="p">})();</span>
</pre></div>
        </td>
      </tr>
